          ...
          <div>
            ...
            <div class="d-none d-lg-block" style="text-align: right;">
              ...
              <small class="btn-xs btn-color-1 intro">
                {{ $root.formatDate(entry.lastCrawlTime) }}
              </small>
              <br />
            </div>
            <div class="d-md-none" style="text-align: right;">
              ...
              &nbsp;
              <small class="btn-xs btn-color-1 intro">
                {{ $root.simpleFormatDate(entry.lastCrawlTime) }}
              </small>
              <br />
            </div>
          </div>
    ...
    return {
      ...
      meta: [
        ...
        { vmid: "og:title", property: "og:title", content: this.entry.title },
        {
          vmid: "og:url",
          property: "og:url",
          content: `info/${this.type}/${this.entry.novelID}`
        },
        {
          vmid: "og:description",
